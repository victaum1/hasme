...
*** Level 3.2: Evaluation, More primitives (DONE)
*** Level 3.3: Evaluation, Special form 'if' (DONE)
*** Level 3.3: Evaluation, List primitives (DONE)
*** Level 3.3: Evaluation, Equal? and Weak Typing (TODO)
*** Level 4: Basic IO, Building a REPL (DONE)
